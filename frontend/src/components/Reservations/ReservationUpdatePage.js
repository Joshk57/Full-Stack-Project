...
import { fetchReservation, getReservation, updateReservation } from "../../store/reservations";
...
const ReservationUpdatePage = () => {
    ...
    //   const totalPrice = () => {
    //     return reservation.listing.price * calculateNumberOfNights();
    //   };
    
    
    //   const handleGuestCountChange = (newCount) => {
    //     const maxGuests = reservation.listing.maxGuests; 
    ...
    //   };
      ...
      //   const totalPrice = reservation.listing.price * numNights
    ...
    return (
        ...
        <div>
          <div>hello</div>
        {reservation && <UpdateDatePicker listing={reservation.listing} />}
        </div>
